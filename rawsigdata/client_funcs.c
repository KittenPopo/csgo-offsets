...
CBaseModPanel::InTeamLobby()=8B ? ? ? ? ? 85 C9 74 35 8B 01 FF 50 34=lumina=CBaseModPanel=241
...
CBaseSaveGameDialog::OnPanelSelected()=56 8B F1 6A 01 68 ? ? ? ? 8B=lumina=CBaseSaveGameDialog=280
...
CCSBaseAchievement::ApplySettings()=55 8B EC 57 FF 75 08 8B F9 E8 ? ? ? ? 8B 4D 08 6A=lumina=CAchievementCS_Medalist=24
...
CColorOperationListPanel::OnReadFileFromDisk()=55 8B EC 83 EC 10 56 8B 75 08 57 56=lumina=C_EntityClassList<class C_PointCamera>=370
...
CIronSightController::IncreaseDotBlur()=55 8B EC 83 EC 18 53 8B D9 E8 ? ? ? ? 83=lumina=CGameMenuItem=128
...
CMsgSteamDatagramLinkInstantaneousStats::Clear()=80 79 2C 00 74 38=lumina=CMsgItemAcknowledged__DEPRECATED=3
...
CParticleEffectBinding::GetActiveParticleList()=55 8B EC 53 8B D9 66=lumina=C_EntityClassList<class C_PointCamera>=424
...
CPlayerLogoProxy::Init()=55 8B EC 51 56 8B 75 08 57 8B F9 C6 45 FF 00 6A 01=lumina=CPlayerLogoProxyForModelWeaponPreviewPanel=0
...
CStickerSelectionProxy::Init()=55 8B EC 83 EC 0C 56 FF 75 0C 8B F1 FF 75 08 E8 ? ? ? ? 84 C0 75 09=lumina=CStickerPeelProxy=0
...
CryptoPP::Algorithm::AlgorithmName()=55 8B EC 56 8B 75 08 8B CE 6A 07=lumina=CryptoPP::ArraySink=2
CryptoPP::BitBucket::AlgorithmName()=51 56 8B 74 24 0C 8B CE 6A 09=lumina
CryptoPP::ByteQueue::IsolatedInitialize()=51 56 8B F1 C7 ? ? ? ? ? ? ? 8B 4C=lumina=CryptoPP::DERSequenceEncoder=7
...
GCSDK::CSharedObjectTypeCache::Dump()=56 57 8B F9 FF 77 18 FF=lumina=GCSDK::CSharedObjectTypeCache=6
...
private: virtual void ConVar::InternalSetFloatValue(float)=55 8B EC 83 EC 28 56 8B F1 F3 ? ? ? ? F3 ? ? ? ? 31=pdb=CBoundedCvar_Interp=15
private: virtual void ConVar::InternalSetIntValue(int)=55 8B EC 83 EC 28 56 8B F1 57 8B=pdb=CBoundedCvar_Interp=16
private: virtual void vgui::Panel::InternalMousePressed(int)=55 8B EC 56 8B F1 8B ? ? ? ? ? 57 8B 01 FF 50 18=pdb
private: virtual void vgui::Panel::Think(void)=56 8B F1 8B 06 8B ? ? ? ? ? FF D0 84 C0 74 3B=pdb=C_EntityClassList<class C_PointCamera>=254
private: virtual void vgui::RichText::MoveScrollBar(int)=55 8B EC 8B 45 08 8B 11=pdb
private: virtual void vgui::TextEntry::OnSetState(int)=55 8B EC 83 EC 40 8D 45 C0 56 FF=pdb=CBaseHudChatEntry=284
...
protected: virtual bool vgui::TextEntry::DrawCursor(int,int)=55 8B EC 83 EC 08 56 8B F1 80 ? ? ? ? ? ? 75=pdb=CBaseHudChatEntry=270
protected: virtual int vgui::ListPanel::GetStartItem(void)=55 8B EC 51 56 57 8B F9 8B 07 8B=pdb=vgui::ListPanel=278
protected: virtual void CBaseViewport::Paint(void)=8B ? ? ? ? ? 56 81 ? ? ? ? ? 75 0F 8B ? ? ? ? ? 8B C6 35 ? ? ? ? EB 11 8B 01 FF 50 34 8B ? ? ? ? ? 8B ? ? ? ? ? 85=pdb=CHudViewport=128
...
protected: virtual void vgui::Image::DrawPrintChar(wchar_t)=55 8B EC 8B ? ? ? ? ? 6A 00 FF 75 08 8B 01 FF 50 74=pdb=BitmapImage=29
protected: virtual void vgui::Image::DrawSetTextPos(int,int)=55 8B EC 8B 41 08 8B ? ? ? ? ? 03 45 0C 56 50 8B 41 04 8B CA 8B 32 03 45 08 50 FF 56 68 5E=pdb=BitmapImage=26
...
protected: virtual void vgui::Menu::OnMouseWheeled(int)=55 8B EC 56 8B F1 8B ? ? ? ? ? 8B 01 8B ? ? ? ? ? FF D0 84 C0 74 2E=pdb=CGameMenu=108
protected: virtual void vgui::Menu::OnSliderMoved(void)=56 6A 00 8B F1 E8 ? ? ? ? 8B 06=pdb=CGameMenu=260
protected: virtual void vgui::Menu::OnTypeAhead(wchar_t)=55 8B EC 81 ? ? ? ? ? 56 8B F1 83 ? ? ? ? ? ? 0F ? ? ? ? ? FF=pdb=CGameMenu=264
...
protected: virtual void vgui::Panel::OnStartDragging(void)=57 8B F9 8B ? ? ? ? ? 6A 6B=pdb=C_EntityClassList<class C_PointCamera>=438
...
protected: virtual void vgui::Slider::DrawNob(void)=55 8B EC 83 EC 14 53 56 8B D9 8D=pdb=CCvarSlider=227
protected: virtual void vgui::Slider::DrawTickLabels(void)=55 8B EC 83 EC 18 56 8B F1 8D 4D F0=pdb=CCvarSlider=229
...
protected: virtual void vgui::TextEntry::PerformLayout(void)=56 8B F1 E8 ? ? ? ? 8B 06 8B CE FF ? ? ? ? ? 80=pdb=CBaseHudChatEntry=132
...
public: virtual bool C_Team::ContainsPlayer(int)=55 8B EC 56 8B ? ? ? ? ? 33 D2 85 F6 7E 1C 8B ? ? ? ? ? 8B 4D 08 0F ? ? ? ? ? ? 39=pdb=C_Team=194
...
public: virtual bool CryptoPP::Store::GetNextMessage()=56 8B F1 80 7E 10 00 75=lumina=CryptoPP::StringStore=25
...
public: virtual bool std::error_category::equivalent()=55 8B EC 8B 01 8D 55 F8 83 EC 08 56=lumina=std::error_category=4
public: virtual bool std::error_category::equivalent()=55 8B EC 8B 41 04 56 8B=lumina=std::error_category=4
...
public: virtual bool vgui::Panel::HasParent(unsigned int)=55 8B EC 8B 45 08 85 C0 75 06 32=pdb=C_EntityClassList<class C_PointCamera>=296
public: virtual bool vgui::Panel::IsAutoDeleteSet(void)=0F B7 41 64 C1 E8 06=pdb
public: virtual bool vgui::Panel::IsBuildGroupEnabled(void)=53 56 8B F1 57 8B ? ? ? ? ? 83 FA FF 0F=pdb=C_EntityClassList<class C_PointCamera>=330
public: virtual bool vgui::Panel::IsCursorNone(void)=8B 01 FF ? ? ? ? ? 85 C0 0F 94 C0 C3=pdb
public: virtual bool vgui::Panel::IsCursorOver(void)=55 8B EC 83 EC 20 53 56 8B D9 8D=pdb=C_EntityClassList<class C_PointCamera>=332
...
public: virtual bool vgui::Panel::IsOpaque(void)=56 8B F1 8B 06 8B ? ? ? ? ? FF D0 84 C0 74 17=pdb=C_EntityClassList<class C_PointCamera>=336
...
public: virtual float CInput::GetLookSpring(void)=55 8B EC 51 8B ? ? ? ? ? 81 ? ? ? ? ? 75 14=pdb=CInput=26
...
public: virtual float ConVar::GetFloat(void)const=55 8B EC 51 8B 51 1C 3B=pdb=CEmptyGameUIConVar=12
...
public: virtual int C_BaseEntity::GetRenderFlags(void)=8B 01 FF 50 20 8B D0 85 D2 74 1B=pdb=C_BaseParticleEntity=192
...
public: virtual int C_Team::GetGGLeader(int)=55 8B EC 8B 45 08 83 F8 03 75=pdb=C_Team=196
...
public: virtual int vgui::Label::SetTextImageIndex(int)=55 8B EC 53 8B 5D 08 57 8B F9 8B ? ? ? ? ? 3B=pdb=CHudChatFilterCheckButton=239
...
public: virtual unsigned int CryptoPP::ByteQueue::Peek()=8B 41 14 8B 50=lumina=CryptoPP::DERSequenceEncoder=20
public: virtual unsigned int CryptoPP::Filter::CopyRangeTo2()=8B 01 FF ? ? ? ? ? FF 74 24 18 8B C8 FF=lumina=CryptoPP::SourceTemplate<class CryptoPP::StringStore>=32
public: virtual unsigned int vgui::Panel::GetVParent(void)=57 8B ? ? ? ? ? 85 FF 74 10 8B 01 56 8B 37 FF 10 50 8B CF FF 56 50=pdb
public: virtual unsigned long vgui::Panel::GetScheme(void)=53 8B D9 8B ? ? ? ? ? 85 C0 75=pdb=C_EntityClassList<class C_PointCamera>=273
...
public: virtual void CBaseAchievement::SetShowOnHUD(bool)=55 8B EC 53 8A 5D 08 38=pdb=IAchievement=29
...
public: virtual void CBaseViewport::LevelInit(void)=56 57 8B F9 33 F6 39 77 50=pdb=CHudViewport=260
public: virtual void CBaseViewport::SetParent(unsigned int)=55 8B EC 56 8B 75 08 57 56 8B F9 E8 ? ? ? ? 6A 01 8B=pdb=CHudViewport=41
...
public: virtual void CCSUsrMsg_QuestProgress::Clear(void)=80 79 1C 00 74 19=pdb=CMsgGCHVacVerificationChange=3
public: virtual void CCSUsrMsg_RawAudio::Clear(void)=8B 41 1C 84 C0 74 38 C1 E8 03=pdb=CSOEconClaimCode=3
...
public: virtual void CGCMsgSQLStatsResponse::Clear(void)=8B 41 30 84 C0 74 38=pdb=CMsgGCCStrike15_v2_Party_Register=3
...
public: virtual void CMsgAMAddFreeLicense::Clear(void)=8B 41 20 84 C0 74 3F C1 E8 03=pdb=CVDiagnostic=3
public: virtual void CMsgAMGetUserGameStats::Clear(void)=80 79 28 00 74 1C=pdb=CMsgGCGiftedItems=3
public: virtual void CMsgConVarValue::Clear(void)=80 79 14 00 74 47=pdb=CMsgConVarValue=3
...
public: virtual void CNetGraphPanelInterface::Destroy(void)=56 8B F1 8B 4E 04 85 C9 74 1B 8B 01 6A 00 FF ? ? ? ? ? 8B 4E 04 85 C9 74 0A 8B 01 6A 01 FF ? ? ? ? ? 5E=pdb=CDebugOverlayPanel=1
...
public: virtual void CSOLobbyInvite::Clear(void)=8B 41 20 84 C0 74 3F C1 E8 02 C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7=pdb=CSOLobbyInvite=3
...
public: virtual void CSVCMsg_Sounds::Clear(void)=56 8B F1 57 80 7E 20 00 74 04=pdb=CCSUsrMsg_ProcessSpottedEntityUpdate=3
...
public: virtual void CSave::SetWritePos(int)=55 8B EC 8B 55 08 8B 49=pdb=CRestore=1
...
public: virtual void CViewRender::FreezeFrame(float)=55 8B EC F3 ? ? ? ? 0F 57 C0 0F 2E D0=pdb=CViewRender=31
public: virtual void CViewRender::StartPitchDrift(void)=55 8B EC 51 A1 ? ? ? ? 56 8B F1 F3 ? ? ? ? 0F=pdb
public: virtual void CViewRender::StopPitchDrift(void)=A1 ? ? ? ? F3 ? ? ? ? 0F 5A C0 C6=pdb=CViewRender=9
...
public: virtual void vgui::Button::SetBlink(bool)=55 8B EC 56 8B F1 8A 4D 08 66=pdb=CHudChatFilterCheckButton=257
public: virtual void vgui::ComboBox::HideMenu(void)=56 8B F1 8B ? ? ? ? ? 85 C9 74 21=pdb=CLabeledCommandComboBox=305
public: virtual void vgui::ComboBox::ShowMenu(void)=56 8B F1 8B ? ? ? ? ? 85 C9 74 15 8B 01 6A=pdb=CLabeledCommandComboBox=304
public: virtual void vgui::Frame::Activate(void)=53 8B D9 56 57 8B 03 FF ? ? ? ? ? 8B 03 8B CB 8B=pdb
public: virtual void vgui::Frame::ActivateMinimized(void)=53 8B D9 8B 03 8B ? ? ? ? ? FF D0 84 C0 74 10=pdb=CCommentaryModelViewer=239
public: virtual void vgui::Frame::FlashWindowStop(void)=53 8B D9 56 8B ? ? ? ? ? 57 8B 03 6A 00 8B 3E FF 10 50 8B CE FF ? ? ? ? ? 80=pdb=CCommentaryModelViewer=255
public: virtual void vgui::Frame::SetSizeable(bool)=55 8B EC 8A ? ? ? ? ? 32 45 08 24 01 30 ? ? ? ? ? E8=pdb
public: virtual void vgui::Frame::SetSmallCaption(bool)=55 8B EC 8A 45 08 C0 E0 03 32 ? ? ? ? ? 24 08 30 ? ? ? ? ? 8B=pdb=CCommentaryModelViewer=261
public: virtual void vgui::Frame::SetTitleBarVisible(bool)=55 8B EC 53 8B 5D 08 8A C3=pdb=CCommentaryModelViewer=258
...
public: virtual void vgui::Label::SetImagePreOffset(int,int)=55 8B EC 8B 45 08 8B D1 85 C0 78 3F=pdb=CHudChatFilterCheckButton=232
...
public: virtual void vgui::Menu::ActivateItem(int)=55 8B EC 56 8B 75 08 57 8B F9 85 F6 78 4E=pdb=CGameMenu=251
public: virtual void vgui::Menu::ActivateItemByRow(int)=55 8B EC 56 8B 75 08 85 F6 78 19=pdb=CGameMenu=252
public: virtual void vgui::Menu::MoveMenuItem(int,int)=55 8B EC 51 8B C1 53 56 33 F6 89 45 FC 8B ? ? ? ? ? 85=pdb=CGameMenu=238
public: virtual void vgui::Menu::OnKeyTyped(wchar_t)=55 8B EC 81 ? ? ? ? ? 56 57 8B 7D 08 8B F1 66 85=pdb=CGameMenu=123
public: virtual void vgui::Menu::OnKillFocus(void)=55 8B EC 51 53 8B D9 8B ? ? ? ? ? 56 57 89 5D FC 8B 01 FF 50=pdb
public: virtual void vgui::Menu::SetFont(unsigned long)=55 8B EC 8B 55 08 56 8B F1 89=pdb=CGameMenu=256
...
public: virtual void vgui::Panel::MarkForDeletion(void)=53 8B D9 F6 43 64=pdb=C_EntityClassList<class C_PointCamera>=333
public: virtual void vgui::Panel::MoveToFront(void)=53 8B D9 56 57 8B 03 8B ? ? ? ? ? FF D0 84 C0 8B CB=pdb=C_EntityClassList<class C_PointCamera>=311
...
public: virtual void vgui::Panel::PaintBuildOverlay(void)=55 8B EC 83 EC 08 56 8B ? ? ? ? ? 8D 45 FC 57 50 8D 45 F8 8B 3E 50 8B 01 FF 10 50 8B CE FF 57 14 8B ? ? ? ? ? 68 ? ? ? ? 6A 00 6A=pdb=C_EntityClassList<class C_PointCamera>=383
...
public: virtual void vgui::Panel::SetDragEnabled(bool)=55 8B EC 53 8A 5D 08 56 8B F1 8B 46=pdb=C_EntityClassList<class C_PointCamera>=397
...
public: virtual void vgui::Panel::SetMouseInputEnabled(bool)=55 8B EC 8B 01 56 8B ? ? ? ? ? 57 FF 75 08 8B 3E FF 10 50 8B CE FF ? ? ? ? ? 8B=pdb=C_EntityClassList<class C_PointCamera>=388
public: virtual void vgui::Panel::SetParent(unsigned int)=55 8B EC 51 8B 45 08 53 8B D9 89=pdb=C_EntityClassList<class C_PointCamera>=295
public: virtual void vgui::Panel::SetScheme(unsigned long)=55 8B EC 8B 45 08 3B ? ? ? ? ? 74 06=pdb=C_EntityClassList<class C_PointCamera>=338
...
public: virtual void vgui::Slider::SetRange(int,int)=55 8B EC 8B 55 08 8B ? ? ? ? ? 56 8B=pdb=CCvarSlider=213
public: virtual void vgui::Slider::SetValue(int,bool)=55 8B EC 8B 45 08 56 8B F1 57 8B ? ? ? ? ? 8B=pdb=CCvarSlider=211
...
public: virtual void vgui::TextEntry::GotoDown(void)=55 8B EC 83 EC 08 57 8B F9 6A 00 8B 07 FF ? ? ? ? ? 80 ? ? ? ? ? ? 74 13=pdb=CBaseHudChatEntry=220
public: virtual void vgui::TextEntry::GotoFirstOfLine(void)=56 8B F1 6A 00 8B 06 FF ? ? ? ? ? 8B CE=pdb=CBaseHudChatEntry=223
public: virtual void vgui::TextEntry::GotoLeft(void)=56 8B F1 6A 00 8B 06 FF ? ? ? ? ? 8B ? ? ? ? ? 33=pdb=CBaseHudChatEntry=217
public: virtual void vgui::TextEntry::GotoTextStart(void)=56 8B F1 6A 00 8B 06 FF ? ? ? ? ? 8B 06 8B CE C7=pdb
public: virtual void vgui::TextEntry::GotoUp(void)=55 8B EC 83 EC 08 57 8B F9 6A 00 8B 07 FF ? ? ? ? ? 80 ? ? ? ? ? ? 74 1E=pdb=CBaseHudChatEntry=219
...
public: virtual void vgui::TextEntry::MoveCursor(int,int)=55 8B EC 83 EC 1C 8B 45 08 56 8B=pdb=CBaseHudChatEntry=252
public: virtual void vgui::TextEntry::SaveUndoState(void)=8B ? ? ? ? ? 53 8B ? ? ? ? ? 56 8B=pdb=CBaseHudChatEntry=247
public: virtual void vgui::TextEntry::SelectNone(void)=8B 01 C7 ? ? ? ? ? ? ? ? ? FF 60=pdb
public: virtual void vgui::TextEntry::SetEditable(bool)=55 8B EC 53 8A 5D 08 56 8B F1 51=pdb=CBaseHudChatEntry=250
public: virtual void vgui::TextEntry::SetEnabled(bool)=55 8B EC 56 FF 75 08 8B F1 E8 ? ? ? ? 8B 06 8B CE FF 50=pdb
public: virtual void vgui::TextEntry::SetFont(unsigned long)=55 8B EC 8B 45 08 56 8B F1 6A 00=pdb=CBaseHudChatEntry=248
public: virtual void vgui::TextEntry::Undo(void)=55 8B EC 83 EC 08 53 56 8B F1 57 8D ? ? ? ? ? 89=pdb=CBaseHudChatEntry=246
...
vgui::MenuButton::OnKillFocus()=55 8B EC 56 57 6A 00 8B F1 8B 4D 08 68 ? ? ? ? E8 ? ? ? ? 85 C0 74 0B 80 78 10 04 75 05 8B 78=lumina=vgui::FrameSystemButton=292
...
vgui::Panel::OnContinueDragging()=55 8B EC 83 EC 10 53 8B D9 8B 43 28=lumina=C_EntityClassList<class C_PointCamera>=439
...
vgui::PropertyDialog::ActivateBuildMode()=55 8B EC 83 EC 10 53 8B D9 80 ? ? ? ? ? ? 74=lumina=CHudChatHistory=102
...
vgui::TextEntry::GetDropContextMenu()=55 8B EC 56 57 8B 7D 08 8B F1 6A 00 56=lumina=CBaseHudChatEntry=154
