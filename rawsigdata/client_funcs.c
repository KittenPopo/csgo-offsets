...
public: virtual void CMsgWebAPIRequest::Clear(void)=56 8B F1 80 7E 28 00 0F ? ? ? ? ? F6=pdb=CMsgWebAPIRequest=3
public: virtual int CMsgWebAPIRequest::ByteSize(void)const=56 8B F1 57 33 FF 80 7E 28 00 0F ? ? ? ? ? F6 46 28 01 74 25=pdb=CMsgWebAPIRequest=8
public: virtual void CMsgHttpResponse::Clear(void)=56 8B F1 8B 46 24 84 C0 74 2A=pdb=CCommunity_GetGamePersonalDataEntries_Response=3
public: virtual void CMsgNotifyWatchdog::Clear(void)=8B 41 28 84 C0 74 4A=pdb=CMsgNotifyWatchdog=3
...
public: virtual void CIPLocationInfo::Clear(void)=8B 41 24 84 C0 0F=pdb=CIPLocationInfo=3
...
public: virtual int CMsgApplySticker::ByteSize(void)const=56 57 8B F9 33 F6 80 7F 28 00 0F ? ? ? ? ? F6 47 28 01 74 11 FF 77 0C FF 77 08 E8 ? ? ? ? 83 C4 08 8D 70 01 8B 47 28 D1 E8 A8 01 74 11=pdb=CMsgApplySticker=8
public: virtual int CMsgGCBannedWord::ByteSize(void)const=56 57 8B F9 33 F6 80 7F 18 00 0F ? ? ? ? ? F6 47 18 01 74 1B 8B 47 08=pdb
public: virtual int CMsgGameServerInfo::ByteSize(void)const=53 56 57 8B F9 33 F6 8B 57 64=pdb=CMsgGameServerInfo=8
public: virtual int CMsgInviteToParty::ByteSize(void)const=56 57 8B F9 33 F6 8B 4F 1C 84 C9 74 59=pdb=CMsgInviteToParty=8
public: virtual int CSOItemCriteria::ByteSize(void)const=55 8B EC 51 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 8B 4F 38=pdb
public: virtual int CSOItemRecipe::ByteSize(void)const=55 8B EC 51 53 56 8B F1 C7 ? ? ? ? ? ? 57 33 FF 80 7E 74=pdb=CSOItemRecipe=8
public: virtual void CMsgGCReportAbuse::Clear(void)=8B 41 34 84 C0 74 5A=pdb=CMsgGCReportAbuse=3
public: virtual void CMsgGameServerInfo::Clear(void)=8B 41 64 84=pdb=CMsgGameServerInfo=3
public: virtual void CMsgPartyInviteResponse::Clear(void)=80 79 20 00 74 20 C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C6=pdb=CMsgPartyInviteResponse=3
public: virtual void CMsgUpdateItemSchema::Clear(void)=80 79 1C 00 74 75=pdb=CMsgUpdateItemSchema=3
public: virtual void CMsgUseItem::Clear(void)=80 79 38 00 74 31=pdb=CMsgUseItem=3
...
public: virtual void CSOItemCriteriaCondition::Clear(void)=8B 41 20 84 C0 74 5A=pdb=CSOItemCriteriaCondition=3
public: virtual void CSOItemRecipe::Clear(void)=56 8B F1 57 8B 46 74=pdb=CSOItemRecipe=3
...
private: virtual void CSOEconItem::SetCachedSize(int)const=55 8B EC 8B 45 08 89 41 74=pdb=CSOEconItem=16
private: virtual void CSOItemRecipe::SetCachedSize(int)const=55 8B EC 8B 45 08 89 41 70=pdb=CSOItemRecipe=16
public: virtual CSOEconCoupon::~CSOEconCoupon(void)=56 8B F1 8D 4E 04 C7 ? ? ? ? ? E8 ? ? ? ? 8B CE 5E=pdb
public: virtual int CPreMatchInfoData::ByteSize(void)const=55 8B EC 51 53 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 80 7F 24 00 74 68=pdb=MLTick=8
...
public: virtual void CSOPersonaDataPublic::Clear(void)=56 8B F1 8B 46 18 84 C0 74 1D=pdb=CSOPersonaDataPublic=3
...
public: virtual void TournamentPlayer::Clear(void)=8B 41 28 84 C0 0F=pdb=TournamentPlayer=3
...
public: virtual void CEngineGotvSyncPacket::Clear(void)=8B 41 34 84 C0 74 3F=pdb=CMsgGCCStrike15_v2_ClientReportPlayer=3
public: CCSUsrMsg_ResetHud::CCSUsrMsg_ResetHud(void)=56 8B F1 8D 4E 04 C7 ? ? ? ? ? E8 ? ? ? ? C7 ? ? ? ? ? ? 8B C6 C6 46 08 00 C7 ? ? ? ? ? ? 5E=pdb
public: virtual int CCSUsrMsg_HudMsg::ByteSize(void)const=53 56 57 8B F9 33 F6 8B 57 34=pdb=CCSUsrMsg_HudMsg=8
public: virtual int CCSUsrMsg_RadioText::ByteSize(void)const=55 8B EC 51 53 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 80 7F 28 00 0F ? ? ? ? ? F6 47 28 01 74 26=pdb=CCSUsrMsg_RadioText=8
public: virtual int CCSUsrMsg_ReportHit::ByteSize(void)const=53 56 57 8B F9 33 F6 8B 5F 1C 84 DB 74=pdb=CCSUsrMsg_ReportHit=8
public: virtual int CCSUsrMsg_SayText2::ByteSize(void)const=55 8B EC 51 53 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 80 7F 28 00 74=pdb=CCSUsrMsg_SayText2=8
public: virtual int CCSUsrMsg_Shake::ByteSize(void)const=56 57 8B F9 33 F6 80 7F 1C 00 74 53=pdb=CCSUsrMsg_Shake=8
public: virtual int CCSUsrMsg_VGUIMenu::ByteSize(void)const=55 8B EC 51 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 80 7F 24 00 74 37=pdb=CCSUsrMsg_VGUIMenu=8
public: virtual int CCSUsrMsg_VoiceMask::ByteSize(void)const=55 8B EC 83 EC 08 8B 41 20=pdb=CCSUsrMsg_VoiceMask=8
public: virtual void CCSUsrMsg_Damage::Clear(void)=56 8B F1 8B 46 18 84 C0 74 20 D1 E8 C7 ? ? ? ? ? ? A8=pdb
public: virtual void CCSUsrMsg_DisplayInventory::Clear(void)=80 79 14 00 74 0B C6=pdb=CCSUsrMsg_DisplayInventory=3
public: virtual void CCSUsrMsg_Fade::Clear(void)=56 8B F1 8B 46 1C 84 C0 74 28 C1 E8 03=pdb=CCSUsrMsg_Fade=3
public: virtual void CCSUsrMsg_HudMsg::Clear(void)=56 8B F1 8B 46 34=pdb=CCSUsrMsg_HudMsg=3
...
public: virtual void CCSUsrMsg_VGUIMenu::Clear(void)=56 8B F1 57 80 7E 24 00 74 26=pdb=CCSUsrMsg_VGUIMenu=3
public: virtual void CCSUsrMsg_VoiceMask::Clear(void)=56 8B F1 57 F7 ? ? ? ? ? ? 74 04=pdb=CCSUsrMsg_VoiceMask=3
...
public: virtual int CCLCMsg_ClientInfo::ByteSize(void)const=56 8B F1 57 33 FF 8B 4E 2C=pdb=CCLCMsg_ClientInfo=8
public: virtual int CMsgVector2D::ByteSize(void)const=56 57 8B F9 33 F6 8B 4F 14 84 C9 74 18 8A C1 24 01 0F B6 F0 F7 DE 1B F6 D1 E9 83 E6 05 F6 C1 01 74 03 83 C6 05 8B 47=pdb=CMsgVector2D=8
...
public: virtual int CNETMsg_SignonState::ByteSize(void)const=55 8B EC 51 53 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 80 7F 2C 00 0F ? ? ? ? ? F6 47 2C 01 74 1B=pdb=CNETMsg_SignonState=8
public: virtual int CSVCMsg_Menu::ByteSize(void)const=56 57 8B F9 33 F6 80 7F 14 00 74 5E=pdb
public: virtual int CSVCMsg_SendTable::ByteSize(void)const=55 8B EC 51 53 56 57 8B F9 C7 ? ? ? ? ? ? 33 F6 8B 47 24=pdb=CSVCMsg_SendTable=8
public: virtual int CSVCMsg_VoiceData::ByteSize(void)const=56 57 8B F9 33 F6 80 7F 34=pdb=CSVCMsg_VoiceData=8
public: virtual void CCLCMsg_ClientInfo::Clear(void)=8B 41 2C 84 C0 74 3E=pdb=CCLCMsg_ClientInfo=3
public: virtual void CCLCMsg_FileCRCCheck::Clear(void)=8B 41 38 84 C0 0F=pdb=CCLCMsg_FileCRCCheck=3
public: virtual void CCSUsrMsg_ShowMenu::Clear(void)=8B 41 18 84 C0 74 31=pdb
public: virtual void CCLCMsg_VoiceData::Clear(void)=80 79 2C 00 74 4C=pdb=CCLCMsg_VoiceData=3
public: virtual void CMsg_CVars_CVar::Clear(void)=80 79 18 00 74 4E=pdb=CMsg_CVars_CVar=3
public: virtual void CNETMsg_File::Clear(void)=8B 41 18 84 C0 74 2F=pdb
public: virtual void CSVCMsg_BSPDecal::Clear(void)=56 8B F1 80 7E 20 00 74 2B=pdb=CSVCMsg_BSPDecal=3
public: virtual void CSVCMsg_ClassInfo_class_t::Clear(void)=8B 41 18 84 C0 74 4F=pdb
public: virtual void CSVCMsg_CreateStringTable::Clear(void)=80 79 2C 00 74 6F=pdb=CSVCMsg_CreateStringTable=3
public: virtual void CSVCMsg_FixAngle::Clear(void)=56 8B F1 8B 46 14 84 C0 74 16=pdb=CSVCMsg_FixAngle=3
public: virtual void CSVCMsg_GameEvent_key_t::Clear(void)=8B 41 38 84 C0 74 57=pdb=CSVCMsg_GameEvent_key_t=3
public: virtual void CSVCMsg_PacketEntities::Clear(void)=8B 41 24 84 C0 74 45=pdb=CSVCMsg_PacketEntities=3
public: virtual void CCSUsrMsg_SendAudio::Clear(void)=80 79 10 00 74 22=pdb
public: virtual void CSVCMsg_SendTable::Clear(void)=56 8B F1 57 8B 46 24 84 C0 74 2A D1=pdb=CSVCMsg_SendTable=3
public: virtual void CSVCMsg_Sounds_sounddata_t::Clear(void)=8B 41 4C 84=pdb=CSVCMsg_Sounds_sounddata_t=3
public: virtual void CSVCMsg_TempEntities::Clear(void)=8B 41 18 84 C0 74 2E C1 E8 02 C6=pdb=CSVCMsg_TempEntities=3
public: virtual void CSVCMsg_VoiceData::Clear(void)=8B 41 34 84 C0 74 55=pdb=CSVCMsg_VoiceData=3
...
public: virtual void CAchievementMgr::Shutdown(void)=53 56 57 8B D9 E8 ? ? ? ? 0F=pdb=CAchievementMgr=3
public: virtual void CAchievementMgr::Update(float)=56 57 8B F9 8B ? ? ? ? ? 85 C9 75 18=pdb=CAchievementMgr=14
...
public: virtual void C_ClientRagdoll::ClientThink(void)=55 8B EC 83 EC 30 56 8B F1 80=pdb=IPVSNotify=27
...
public: virtual void C_ClientRagdoll::SUB_Remove(void)=8B 01 51 C6 ? ? ? ? ? ? C7=pdb=C_ClientRagdoll=128
public: virtual void C_BaseAnimating::SetPredictable(bool)=55 8B EC 56 FF 75 08 8B F1 E8 ? ? ? ? 8B CE=pdb=CColorPickerPanel=88
...
public: virtual float C_BasePlayer::GetMinFOV(void)const=A1 ? ? ? ? 83 78 18 01 75 07=pdb=C_BasePlayer=347
...
public: virtual void C_EntityDissolve::UpdateOnRemove(void)=56 8B F1 8B ? ? ? ? ? 85 D2 74 16=pdb=C_EntityDissolve=127
public: virtual void C_EntityFlame::ClientThink(void)=56 8B F1 8D 4E F4=pdb=PrecacheEffectBuildPrecache::CResourcePrecacher=61
...
public: virtual void C_EnvScreenOverlay::ClientThink(void)=F3 ? ? ? ? ? ? ? 0F ? ? ? ? ? ? 9F F6 C4 44 7B 1D=pdb=C_EnvScreenEffect=206
...
public: virtual void C_Func_Dust::ClientThink(void)=55 8B EC 83 EC 1C 56 8B F1 8B ? ? ? ? ? A8=pdb=C_TEDust=52
public: virtual C_FuncSmokeVolume::~C_FuncSmokeVolume(void)=56 8B F1 FF ? ? ? ? ? C7 ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7=pdb
public: virtual void C_GameInstructor::Shutdown(void)=56 57 8B F9 8B ? ? ? ? ? 81 ? ? ? ? ? 75 0C A1 ? ? ? ? 35 ? ? ? ? EB 05 8B 01 FF 50 34 85 C0 7E 21=pdb=C_GameInstructor=3
...
public: virtual void C_LightGlow::ClientThink(void)=55 8B EC 83 EC 0C 56 8B F1 8B 46 F4=pdb=C_LightGlowOverlay=7
RecvProxy_HDRColorScale()=55 8B EC 8B 45 08 8B 48 08 8B 45 0C 89 ? ? ? ? ? 5D=pdb
public: virtual bool C_LightGlow::Simulate(void)=56 8B F1 8B 06 FF 50 28 8B 10=pdb=C_LightGlow=98
...
public: virtual void CRopeManager::ResetRenderCache(void)=56 8B F1 8B 56 10 85 D2 7E=pdb=CRopeManager=1
public: virtual void CRopeManager::SetHolidayLightMode(bool)=55 8B EC 8A 45 08 88 41 40=pdb=CRopeManager=4
void ShakeRopesCallback(class CEffectData const near &)=55 8B EC 83 EC 10 8B 4D 08 F3=pdb
public: virtual bool C_RopeKeyframe::ShouldDraw(void)=A1 ? ? ? ? 56 8B F1 B9 ? ? ? ? FF 50 34 85 C0 75 04=pdb=C_RopeKeyframe::CPhysicsDelegate=14
...
public: virtual void C_SoundscapeSystem::OnRestore(void)=A1 ? ? ? ? 8B 40 04 89 41=pdb=C_SoundscapeSystem=9
public: char const near * CCommand::operator[](int)const=55 8B EC 8B 45 08 85 C0 78 0F=pdb
public: void C_SoundscapeSystem::OnStopAllSounds(void)=56 8B F1 83 ? ? ? ? ? ? 57=pdb=C_SoundscapeSystem=7
...
public: virtual bool C_VGuiScreen::ShouldDraw(void)=8B ? ? ? ? ? C1 E8 05 F6=pdb=CVGuiScreenEnumerator=13
...
public: virtual bool C_World::Init(int,int)=55 8B EC C7 ? ? ? ? ? ? ? ? ? 5D=pdb=C_World=43
...
public: virtual int CFunctorJob::DoExecute(void)=8B 49 48 8B=pdb=CFunctorJob=3
public: virtual int CHLClient::GetInEyeEntity(void)const=E8 ? ? ? ? 85 C0 74 08 8D 48 08=pdb=CHLClient=116
public: virtual void CHLClient::GetStatus(char near *,int)=55 8B EC FF 75 0C FF 75 08 E8 ? ? ? ? 83=pdb=google::protobuf::internal::FieldSkipper=1
public: virtual void CHLClient::HudText(char const near *)=55 8B EC FF 75 08 E8 ? ? ? ? 83 C4 04 5D=pdb=google::protobuf::internal::FieldSkipper=2
...
public: virtual void CHLClient::RetireAllPlayerDecals(bool)=55 8B EC E8 ? ? ? ? 80=pdb=CHLClient=114
...
public: virtual bool CClientThinkList::Init(void)=C7 ? ? ? ? ? ? B0 01 C6 41 4C=pdb=CClientThinkList=1
...
public: virtual bool CShadowLeafEnum::EnumerateLeaf(int,int)=55 8B EC 83 C1 04 8D 45 08 50 FF ? ? ? ? ? E8=pdb=CShadowLeafEnum=0
public: virtual void CShadowModelProxy::OnBind(void near *)=55 8B EC 56 57 FF ? ? ? ? ? 8B F9=pdb=CShadowModelProxy=1
public: virtual void CShadowProxy::OnBind(void near *)=56 FF ? ? ? ? ? 8B F1 8B 4E=pdb=CShadowProxy=1
...
public: virtual void CEffectsList::Flush(void)=55 8B EC 51 56 8B 71 04=pdb=CEffectsList=3
...
public: virtual void CFXQuad::Destroy(void)=56 8B F1 8B 4E 10 85 C9 74=pdb=CFXQuad=4
public: virtual bool CFXQuad::IsActive(void)=F3 ? ? ? ? 0F 2F 41 38=pdb=CFXQuad=3
...
public: virtual void CBaseGameStats_Driver::OnRestore(void)=8B ? ? ? ? ? 8B 01 FF 60 28=pdb=CBaseGameStats_Driver=9
public: void CGameStringPool::PurgeDeferredDeleteList(void)=56 8B F1 57 33 FF 39 7E 2C=pdb
public: virtual bool CHudGeiger::ShouldDraw(void)=8B ? ? ? ? ? 85 C0 7E 13 3D=pdb=CHudGeiger=13
...
public: virtual void CHudCloseCaption::LevelInit(void)=56 8B F1 E8 ? ? ? ? 8D ? ? ? ? ? E8 ? ? ? ? 8B=pdb=CHudCloseCaption=6
public: virtual void CHudCloseCaption::LevelShutdown(void)=56 8B F1 8B 06 C6 ? ? ? ? ? ? FF 50=pdb=CHudCloseCaption=7
public: virtual void CHudCloseCaption::Reset(void)=56 8B F1 80 ? ? ? ? ? ? 75 18=pdb=CHudCloseCaption=8
cc_random()=55 8B EC 56 57 8B 7D 08 BE ? ? ? ? 83=pdb
protected: virtual void CHudHintDisplay::OnThink(void)=55 8B EC 83 EC 08 53 8B D9 8D 4D FC 56 51=pdb=CHudHintDisplay=101
public: virtual void CHudHintKeyDisplay::Reset(void)=6A 00 81 ? ? ? ? ? E8 ? ? ? ? C3=pdb
public: virtual void CLCD::AddChatLine(char const near *)=55 8B EC 83 EC 10 56 8B F1 83 7E=pdb=CLCD=1
public: virtual void CLCDItemIcon::Create(class IG15 near *)=55 8B EC 56 8B F1 57 8B 7D 08 8B CF FF 76 1C=pdb=CLCDItemIcon=1
...
public: virtual bool CPDumpPanel::ShouldDraw(void)=83 ? ? ? ? ? ? 75 03 32=pdb=CPDumpPanel=13
protected: virtual bool CHudSaveStatus::ShouldDraw(void)=55 8B EC 83 EC 08 0F 57 C9 53=pdb=CHudSaveStatus=13
protected: virtual void CHudSubtitles::Reset(void)=56 8B F1 8B ? ? ? ? ? 85 C9 74 0A 8B 01 6A 01 FF ? ? ? ? ? C7=pdb
protected: virtual bool CHudSubtitles::ShouldDraw(void)=55 8B EC 51 53 56 8B F1 8B ? ? ? ? ? 8B 01=pdb=CHudSubtitles=13
public: virtual bool CHudVehicle::ShouldDraw(void)=56 8B F1 E8 ? ? ? ? 85 C0 74 35=pdb=CHudVehicle=13
...
public: virtual float ConVar_m_pitch::GetFloat(void)const=55 8B EC 83 EC 08 56 8B F1 8B ? ? ? ? ? 85 C9=pdb=ConVar_m_pitch=12
public: virtual void CInput::SetFullscreenMousePos(int,int)=55 8B EC A1 ? ? ? ? FF 75 0C FF 75 08 8B 10 FF ? ? ? ? ? 8B=pdb
public: virtual void CLessOrEqualProxy::OnBind(void near *)=55 8B EC 83 EC 14 53 8B D9 56 57 8B 4B=pdb=CLessOrEqualProxy=1
...
private: virtual void CHudMenu::OnThink(void)=80 ? ? ? ? ? ? 74 22 A1=pdb=CHudMenu=125
public: virtual bool CHudMenu::ShouldDraw(void)=56 8B F1 E8 ? ? ? ? 84 C0 74 2F=pdb=CHudMenu=13
...
public: virtual void CHudMessage::Reset(void)=56 8B F1 68 ? ? ? ? 6A 00 8D ? ? ? ? ? 50 E8 ? ? ? ? 83=pdb=CHudMessage=8
public: virtual void CHudMessage::SetDefaultFont(void)=8B 01 FF ? ? ? ? ? FF 50 10=pdb=CHudMessage=242
public: virtual void CHudMessage::SetFont(unsigned long)=55 8B EC 8B 45 08 56 8B F1 8D=pdb=CHudMessage=241
public: virtual void CHudMessage::SetPosition(int,int)=55 8B EC 81 ? ? ? ? ? E8 ? ? ? ? 85 C0 74 14=pdb=CHudMessage=237
public: virtual bool CHudMessage::ShouldDraw(void)=56 8B F1 E8 ? ? ? ? 84 C0 74 16=pdb=CHudMessage=13
public: virtual void CMumbleSystem::PostRender(void)=55 8B EC 81 ? ? ? ? ? 83 ? ? ? ? ? ? 57=pdb=CMumbleSystem=15
...
public: virtual void CLocalSpaceEmitter::Update(float)=8B 01 FF 50 48 C2=pdb=CLocalSpaceEmitter=1
public: virtual void CParticleSystemQuery::PreSimulate(void)=8B D1 33 C0 39 42=pdb=CParticleSystemQuery=30
private: void CPerfVisualBenchmark::Print(void)=55 8B EC 83 EC 10 53 57 8B F9 C7=pdb
public: virtual void CDataObjectAccessSystem::Shutdown(void)=56 57 8D 71 0C=pdb=CDataObjectAccessSystem=3
...
public: virtual void C_PhysPropClientside::ClientThink(void)=55 8B EC 51 F3 ? ? ? ? ? ? ? 0F 57=pdb=C_PhysPropClientside=257
public: virtual float C_PhysPropClientside::GetMass(void)=8B ? ? ? ? ? 85 C9 74 07 8B 01 8B 40 74=pdb=CSoftbodyProcess=129
public: virtual bool C_PhysPropClientside::IsAsleep(void)=8B ? ? ? ? ? 85 C9 74 07 8B 01 8B 40 08=pdb=CSoftbodyProcess=130
public: virtual void C_PhysPropClientside::OnTakeDamage(int)=55 8B EC 80 ? ? ? ? ? ? 74 1A=pdb=C_PhysPropClientside=249
...
public: virtual void CBreakParser::SetDefaults(void near *)=55 8B EC 8B 55 08 C6=pdb=CBreakParser=1
...
public: virtual bool CRenderToRTHelper::Init(void)=83 ? ? ? ? ? ? 57 8B F9 75 04=pdb=CRenderToRTHelper=0
public: void CBaseRopePhysics::SetNumNodes(int)=55 8B EC 8B 45 08 8B D1 56=pdb
public: virtual void CSaveRestoreBlockSet::PostSave(void)=56 8B F1 57 33 FF 39 7E 30 7E 16 0F ? ? ? ? 8B 46 24 8B 0C B8 8B 01 FF 50 10=pdb=CSaveRestoreBlockSet=4
public: virtual void CSaveRestoreBlockSet::PreRestore(void)=56 57 8B F9 33 F6 39 77 30 7E 16=pdb=CSaveRestoreBlockSet=5
public: virtual void CSaveRestoreBlockSet::PostRestore(void)=56 8B F1 57 33 FF 39 7E 30 7E 16 0F ? ? ? ? 8B 46 24 8B 0C B8 8B 01 FF 50 20=pdb=CSaveRestoreBlockSet=8
...
public: virtual void CRestore::EndBlock(void)=56 8B F1 57 8B 56 10=pdb=CRestore=8
public: virtual void CSave::EndBlock(void)=55 8B EC 83 EC 08 53 56 57 8B F9 8B 07 FF 50=pdb=CSave=9
public: virtual void CSave::EndLogging(void)=56 8B F1 8B 56 20=pdb=CSave=1
...
public: virtual int CRestore::ReadTick(int near *,int,int)=55 8B EC 8B 41 1C 53=pdb=CRestore=26
public: virtual int CRestore::ReadTime(float near *,int,int)=55 8B EC 51 8B 41 1C 56 FF=pdb=CRestore=25
public: virtual void CSave::SetWritePos(int)=55 8B EC 8B 55 08 8B 49=pdb
public: virtual void CRestore::SkipEntityData(void)=55 8B EC 51 56 8B F1 57 8B 06 FF=pdb=CRestore=37
public: virtual int CRestore::SkipHeader(void)=55 8B EC 51 8B 01 8D 55 FC 52 FF 50=pdb=CRestore=10
public: virtual void CRestore::StartBlock(void)=55 8B EC 8B 01 8D 55 E0=pdb=CRestore=5
public: virtual void CSave::StartBlock(void)=8B 01 68 ? ? ? ? FF 50 20=pdb=CSave=7
public: virtual void CSave::StartLogging(char const near *)=55 8B EC 56 8B F1 8B ? ? ? ? ? 83 C1=pdb=CSave=0
public: virtual void CSave::WriteInt(int const near *,int)=55 8B EC 8B 45 0C C1 E0 02=pdb
public: virtual void CSave::WriteString(char const near *)=55 8B EC 8B 55 08 8B C2 56 57 8B F1 8D 78 01 90 8A 08 40 84 C9 75 F9 2B C7 8B CE 40=pdb=CSave=23
public: virtual void CSave::WriteTick(int const near *,int)=55 8B EC 51 53 56 57 8B F9 8B 5D=pdb=CSave=34
public: virtual bool CSceneTokenProcessor::GetToken(bool)=55 8B EC 51 56 57 8B F9 8B ? ? ? ? ? 68 ? ? ? ? 8B 01 8D=pdb=CSceneTokenProcessor=1
...
public: virtual bool CSoundEmitterSystem::Init(void)=8B ? ? ? ? ? 68 ? ? ? ? 8B 01 FF 50 44 A3 ? ? ? ? B0=pdb=CSoundEmitterSystem=1
cl_soundemitter_flush()=A1 ? ? ? ? B9 ? ? ? ? FF 50 0C 8B ? ? ? ? ? 8B=pdb
public: virtual void CSoundControllerImp::Update(float)=8B 41 FC 83 C1 FC FF 50 04 C2=pdb=CSoundEnvelopeController=41
public: virtual void CSpatialEntityMgr::Update(float)=57 8B F9 83 7F 18 00 7E=pdb=CSpatialEntityMgr=14
...
public: virtual void C_SpriteTrail::ClientThink(void)=56 8D 71 F4 8B CE E8 ? ? ? ? 8B=pdb=C_SpriteTrail=194
...
public: virtual void CAvatarImage::Paint(void)=53 56 8B F1 57 80 7E 25=pdb=CAvatarImage=0
...
public: virtual void CBitmapButton::Paint(void)=53 56 8B F1 33 DB 8B 06 8B=pdb=CBitmapButton=128
public: virtual class Color BitmapImage::GetColor(void)=55 8B EC 8B 45 08 8B 49 1C=pdb=BitmapImage=14
public: virtual void BitmapImage::Paint(void)=55 8B EC 83 EC 08 56 8B F1 8B 56=pdb=BitmapImage=0
public: virtual void vgui::Image::SetBkColor(class Color)=55 8B EC 8B 01 FF 75 08 FF 50 48=pdb
public: virtual void BitmapImage::SetPos(int,int)=55 8B EC 8B 45 08 89 41 20 8B=pdb=BitmapImage=1
public: virtual void CCenterPrint::Destroy(void)=56 8B F1 8B 4E 04 85 C9 74 22=pdb=CCenterPrint=1
public: virtual void CCenterStringLabel::Print(char near *)=55 8B EC 56 FF 75 08 8B F1 8B 06 FF ? ? ? ? ? 8B ? ? ? ? ? 81=pdb=CCenterStringLabel=253
public: virtual void CDebugOverlay::Paint(void)=55 8B EC 83 EC 1C 89 4D F0=pdb=CDebugOverlay=128
public: virtual bool CDebugOverlay::ShouldDraw(void)=8B ? ? ? ? ? 8B 01 FF 50 38 85=pdb=CDebugOverlay=211
public: virtual void CFPSPanel::DumpStats(void)=56 8B F1 8B ? ? ? ? ? 85 C9 0F ? ? ? ? ? A1=pdb=CFPSPanel=211
private: void CFPSPanel::InitAverages(void)=56 8B F1 68 ? ? ? ? 6A 00 8D ? ? ? ? ? C7 ? ? ? ? ? ? ? ? ? 50=pdb
public: virtual bool CFPSPanel::ShouldDraw(void)=80 ? ? ? ? ? ? 56 8B F1 0F ? ? ? ? ? 8B ? ? ? ? ? 81=pdb=CFPSPanel=212
bool VGui_IsSplitScreenPIP(void)=83 ? ? ? ? ? ? 7C 2A 8B ? ? ? ? ? 81=pdb
public: virtual void CLoadingDisc::Destroy(void)=56 8B F1 8B 4E 04 85 C9 74 1B 8B 01 6A 00 FF ? ? ? ? ? 8B 4E 04 85 C9 74 0A 8B 01 6A 01 FF ? ? ? ? ? 8B=pdb=CLoadingDisc=1
...
public: virtual void CMessageCharsPanel::Paint(void)=55 8B EC 51 53 56 8B ? ? ? ? ? 89 4D FC 57=pdb=CMessageCharsPanel=128
private: void CMovieDisplayScreen::UpdateMovie(void)=56 8B F1 80 ? ? ? ? ? ? 0F ? ? ? ? ? B8 ? ? ? ? 66 ? ? ? ? ? ? 0F=pdb=CMovieDisplayScreen=27
...
public: virtual void VideoPanel::Activate(void)=55 8B EC 51 53 8B D9 56 57 6A 01=pdb=VideoPanel=238
protected: virtual void VideoPanel::OnVideoOver(void)=56 8B F1 6A 00 8B 06 FF ? ? ? ? ? C7=pdb=VideoPanel=280
...
public: virtual void CViewEffects::LevelInit(void)=56 8B F1 8B 06 FF 50 34=pdb=CViewEffects=14
public: virtual void CViewEffects::ClearPermanentFades(void)=53 57 8B F9 8B 5F 18 83 EB 01 78=pdb=CViewEffects=5
public: virtual void CViewEffects::ClearAllFades(void)=56 8B F1 57 8B 7E 18 83 EF 01 78 19=pdb
public: virtual void CViewEffects::Save(class ISave near *)=55 8B EC 51 53 56 8B 75 08 8B D9 57 6A=pdb=CViewEffects=11
private: virtual void CViewEffects::ClearAllShakes(void)=53 56 8B F1 57 33 FF 8B 5E 2C=pdb=CViewEffects=13
...
public: virtual void CViewAngleAnimation::ClientThink(void)=55 8B EC 83 EC 44 53 56 57 8B F9 80=pdb=CViewAngleAnimation=191
...
public: virtual bool CRefractiveGlassView::AdjustView(float)=56 57 8B F9 E8 ? ? ? ? 8B F0 C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? 8B CE 8B 16 FF=pdb=CRefractiveGlassView=4
private: virtual int PruneWorldListInfoJob::DoExecute(void)=55 8B EC 83 EC 0C 8B ? ? ? ? ? 53 56 8B F1=pdb=PruneWorldListInfoJob=3
public: virtual void CFreezeFrameView::Draw(void)=55 8B EC 51 53 8B D9 8B ? ? ? ? ? 56 57 89 5D FC 8B 01 FF ? ? ? ? ? 8B=pdb=CFreezeFrameView=3
public: virtual void CRefractiveGlassView::Draw(void)=56 57 8B F9 8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 8B F0 85 F6 74 07 8B 06 8B CE FF 50 08 8B CF=pdb=CRefractiveGlassView=3
...
public: virtual void CReflectiveGlassView::PushView(float)=55 8B EC 83 EC 10 53 8B D9 8B ? ? ? ? ? 56=pdb=CReflectiveGlassView=5
public: virtual void CRefractiveGlassView::PushView(float)=55 8B EC 83 EC 14 89 4D FC 8B=pdb=CRefractiveGlassView=5
...
public: virtual bool C_CHostage::ShouldDraw(void)=80 ? ? ? ? ? ? 75 19 8B ? ? ? ? ? 83=pdb=C_CHostage=276
...
public: virtual void C_CSPlayer::SetSequence(int)=55 8B EC 80 ? ? ? ? ? ? 74 16=pdb=C_CSPlayer=219
...
public: virtual void CCSModeManager::LevelShutdown(void)=8B ? ? ? ? ? 8B 01 FF 60 68=pdb=CCSModeManager=3
...
public: virtual bool CCSCustomTextureSaver::Init(void)=C7 ? ? ? ? ? ? B0 01 C6 41 20=pdb=CCSCustomTextureSaver=1
public: virtual bool CCSGameMovement::LadderMove(void)=53 56 8B F1 E8 ? ? ? ? 8A D8 84=pdb=CCSGameMovement=43
protected: virtual void CCSGameMovement::PlayerMove(void)=55 8B EC 83 EC 08 56 8B F1 8B ? ? ? ? ? E8=pdb=CCSGameMovement=17
public: virtual void CCSGameMovement::ReduceTimers(void)=55 8B EC 83 EC 08 0F 57 D2 56 8B=pdb=CCSGameMovement=54
...
public: virtual bool C_CSGameRules::IsGameRestarting(void)=8A 41 54=pdb=C_CSGameRules=56
...
public: virtual void CPlayerRankManager::Shutdown(void)=56 57 8B F9 8B ? ? ? ? ? 8B 01 FF 50 2C 8B D7=pdb=CPlayerRankManager=3
...
public: virtual bool CSteamWorksGameStatsClient::Init(void)=E8 ? ? ? ? 6A 01 68 ? ? ? ? B9=pdb=CSteamWorksGameStatsClient=1
...
public: virtual void CBitmapImagePanel::forceReload(void)=56 8B F1 80 ? ? ? ? ? ? 74 1F=pdb=CBitmapImagePanel=212
private: void CBitmapImagePanel::forceUpload(void)=56 8B F1 80 ? ? ? ? ? ? 57 8D ? ? ? ? ? 74 31=pdb
public: virtual void CGameConsole::Activate(void)=56 8B F1 80 7E 04 00 74=pdb=CGameConsole=1
public: virtual void CGameConsole::Clear(void)=80 79 04 00 74 08=pdb=CGameConsole=3
public: virtual bool CGameConsole::IsConsoleVisible(void)=80 79 04 00 75 03 32=pdb=CGameConsole=5
public: virtual void CGameConsole::SetParent(int)=55 8B EC 80 79 04 00 74 0C=pdb=CGameConsole=6
public: virtual void CGameConsole::Shutdown(void)=56 8B F1 8B 4E 08 85 C9 74 1C=pdb=CGameConsole=7
public: virtual bool CGameUI::IsInLevel(void)=8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 85 C0 74 1C 80=pdb=CGameUI=29
public: virtual void CGameUI::SetProgressOnStart(void)=80 49 08=pdb=CGameUI=23
...
public: virtual void COptionsSubKeyboard::ItemSelected(int)=55 8B EC 56 8B F1 57 8B 7D 08 57 8B ? ? ? ? ? 8B=pdb=COptionsSubKeyboard=241
public: virtual void COptionsSubKeyboard::OnResetData(void)=56 8B F1 E8 ? ? ? ? 8B 06 8B CE 8B ? ? ? ? ? FF D0 84 C0 74 10=pdb=COptionsSubKeyboard=236
...
public: virtual void CGammaDialog::OnClose(void)=56 8B F1 6A 01 F3=pdb=CGammaDialog=235
public: virtual void CGammaDialog::OnOK(void)=56 8B F1 8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 8B CE 66=pdb=CGammaDialog=280
public: virtual void COptionsSubVideo::OnResetData(void)=53 8B D9 56 57 C6 ? ? ? ? ? ? 8B ? ? ? ? ? 8B=pdb=COptionsSubVideo=236
public: virtual void COptionsSubVideo::PerformLayout(void)=56 8B F1 E8 ? ? ? ? 83 ? ? ? ? ? ? 74 24=pdb=COptionsSubVideo=132
private: void COptionsSubVoice::EndTestMicrophone(void)=56 8B F1 8B ? ? ? ? ? 85 C0 0F ? ? ? ? ? 80 ? ? ? ? ? ? 0F ? ? ? ? ? 8B 40=pdb
public: virtual void COptionsSubVoice::OnApplyChanges(void)=56 8B F1 83 ? ? ? ? ? ? 0F ? ? ? ? ? 8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 8B=pdb=COptionsSubVoice=237
...
protected: virtual void CPanelListPanel::OnMouseWheeled(int)=55 8B EC 56 8B F1 8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 8B 4D 08 C1 E1 04 2B 4D 08 2B=pdb=CPanelListPanel=108
public: virtual void CPanelListPanel::RemoveItem(int)=55 8B EC 53 56 8B F1 57 8B 7D 08 8B ? ? ? ? ? 8B=pdb=CPanelListPanel=215
public: virtual bool CRunGameEngine::IsInGame(void)=55 8B EC 51 8B ? ? ? ? ? 8B 01 FF ? ? ? ? ? 85 C0 74=pdb=CRunGameEngine=5
...
public: virtual void vgui::URLButton::DoClick(void)=56 8B F1 6A 01 8B 06 FF ? ? ? ? ? 8B 06=pdb=vgui::URLButton=259
private: void vgui::URLButton::Init(void)=56 8B F1 6A 00 6A 00 66=pdb
public: virtual void vgui::URLButton::OnCursorEntered(void)=56 8B F1 8B 06 8B ? ? ? ? ? FF D0 84 C0 74 0C 8B=pdb=vgui::URLButton=103
public: virtual void vgui::URLButton::OnCursorExited(void)=8A ? ? ? ? ? C0 E8 05 A8 01 75 0A=pdb=vgui::URLButton=104
protected: virtual void vgui::Button::OnSetState(int)=55 8B EC 83 7D 08 00 56 8B F1 0F=pdb
public: virtual void vgui::URLButton::PerformLayout(void)=55 8B EC 51 56 57 8B F9 8D 45=pdb=vgui::URLButton=132
public: virtual void vgui::URLButton::SetArmed(bool)=55 8B EC 56 8B F1 8A 4D 08 8A ? ? ? ? ? 24=pdb=vgui::URLButton=250
...
public: virtual void CAsyncCtxSaveGame::Completed(void)=51 8B ? ? ? ? ? E8 ? ? ? ? C3=pdb=CAsyncCtxSaveGame=2
public: virtual void CAsyncCtxSaveGame::ExecuteAsync(void)=8B ? ? ? ? ? 8B 01 8B ? ? ? ? ? FF D0 84 C0 74 28 56=pdb=CAsyncCtxSaveGame=1
...
public: virtual void CGameMenu::OnKillFocus(void)=53 56 57 8B F1 E8 ? ? ? ? 8B ? ? ? ? ? 8B CE 8B 06 8B 1F FF 10 50 8B CF FF ? ? ? ? ? 5F=pdb=CGameMenu=99
...
public: virtual int CHudChat::GetChatInputOffset(void)=56 8B F1 8B ? ? ? ? ? 8B 01 8B ? ? ? ? ? FF D0 84 C0 74 08=pdb=CHudChat=32
public: virtual class Color CHudChat::GetClientColor(int)=55 8B EC 8B 55 0C 85 D2 75 0F=pdb=CHudChat=40
public: virtual void CHudWeaponSelection::LevelInit(void)=8B ? ? ? ? ? 85 C0 79 0B=pdb=CHudWeaponSelection=6
public: virtual bool CRadioStatus::Init(void)=56 8B F1 83 ? ? ? ? ? ? 75 22=pdb
public: virtual void CRadioStatus::Shutdown(void)=56 8B F1 8B ? ? ? ? ? 85 C9 74 05 8B 01=pdb=CRadioStatus=3
menuselect()=55 8B EC 8B 4D 08 8B 01 83 F8 02 0F=pdb
public: virtual bool SFMapOverview::ShouldDraw(void)=56 8B F1 E8 ? ? ? ? 84 C0 75 1E=pdb=CUserMessageBinder::BindParams<25,class CCSUsrMsg_ProcessSpottedEntityUpdate,0>=19
...
public: virtual bool SFHudFreezePanel::ShouldDraw(void)=56 8B F1 80 ? ? ? ? ? ? 74 31=pdb=CCSGO_HudFreezePanel=91
public: virtual bool SFHudInfoPanel::ShouldDraw(void)=56 8B F1 E8 ? ? ? ? 84 C0 74 04 32 C0 5E C3 A1 ? ? ? ? B9 ? ? ? ? FF 50 34 85 C0 74 23=pdb=CCSGO_HudDamageIndicator=91
public: virtual void SFHudMoney::SetActive(bool)=55 8B EC 57 FF 75 08 8B F9 E8 ? ? ? ? FF 75 08 8B CF=pdb
public: virtual void SFHudRadar::Reset(void)=8B 01 6A 01 FF 50 3C=pdb=CCSGO_HudRadar=87
public: virtual bool SFWeaponSelection::ShouldDraw(void)=A1 ? ? ? ? 56 8B F1 B9 ? ? ? ? FF 50 34 85 C0 74 20=pdb=CCSGO_OutOfAmmo=115
public: virtual void C_Item_Healthshot::WeaponIdle(void)=A1 ? ? ? ? 56 8B F1 F3 ? ? ? ? ? ? ? 0F 2F 40 10 77 2F=pdb=C_Item_Healthshot=325
...
public: virtual class Vector C_C4::GetGlowColor(void)=55 8B EC 8B 45 08 C7 ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? 5D=pdb=C_C4=486
...
public: virtual bool C_DEagle::SendWeaponAnim(int)=55 8B EC 8B 45 08 3D ? ? ? ? 75 0F=pdb=C_DEagle=301
public: virtual bool C_WeaponElite::SendWeaponAnim(int)=55 8B EC 8B 45 08 3D ? ? ? ? 75 3C=pdb=C_WeaponElite=301
...
public: virtual unsigned char CEconItem::GetFlags(void)const=8A 41 2C C3=pdb=CEconItem=30
public: virtual bool CEconItem::GetInUse(void)const=B8 ? ? ? ? 66 39 41 22 0F=pdb=CEconItem=34
public: virtual int CEconItem::GetQuality(void)const=0F B7 41 22 C1 E8 05=pdb=CEconItem=28
public: virtual int CEconItem::GetRarity(void)const=53 56 8B F1 57 8B 06 FF 50 30=pdb=CEconItem=29
...
public: virtual void CClientScoreBoardDialog::Reset(void)=56 8B F1 8B 4E 18 8B=pdb=CClientScoreBoardDialog=251
...
public: virtual void CClient_Precipitation::Precache(void)=56 8B F1 83 ? ? ? ? ? ? 0F ? ? ? ? ? 8B ? ? ? ? ? 83=pdb=CClient_Precipitation=34
public: virtual bool C_Embers::Simulate(void)=55 8B EC 51 56 8B F1 80 ? ? ? ? ? ? 75 07=pdb=C_Embers=98
public: virtual void C_MovieExplosion::Update(float)=55 8B EC 83 EC 14 53 8B D9 83 ? ? ? ? ? ? 0F ? ? ? ? ? F3=pdb=FX_CacheMaterialHandlesPrecache::CResourcePrecacher=35
...
public: virtual void C_SporeTrail::Update(float)=55 8B EC 56 8B F1 83 ? ? ? ? ? ? 74 51=pdb=C_DustTrail=197
...
public: virtual void CFXDiscreetLine::Update(double)=55 8B EC F3 ? ? ? ? 0F 5A C0 F2 ? ? ? ? 66 0F 5A C0 F3 ? ? ? ? F3=pdb=CFXDiscreetLine=5
public: virtual void CFXLine::Destroy(void)=56 8B F1 8B 4E 54 85=pdb=CFXLine=4
public: virtual bool CFXLine::IsActive(void)=F3 ? ? ? ? 0F 2F 41 50 0F=pdb=CFXLine=3
public: virtual void CFXLine::Update(double)=55 8B EC F3 ? ? ? ? F2=pdb=CFXLine=5
void InitSmokeFogOverlay(void)=8B ? ? ? ? ? 85 C9 74 0F 8B 01 FF 50 34=pdb
public: virtual void CClientTools::EnableRecordingMode(bool)=55 8B EC 8A 45 08 88 41 38=pdb=CClientTools=32
public: virtual int CClientTools::GetEntIndex(void near *)=55 8B EC 8B 4D 08 85 C9 74 0D 8B 41=pdb=CClientTools=36
public: virtual void CToolFrameworkClient::PreRender(void)=8B 49 04 85 C9 74 05 8B 01 FF 60 14=pdb=CToolFrameworkClient=13
public: virtual void CToolFrameworkClient::PostRender(void)=8B 49 04 85 C9 74 05 8B 01 FF 60 18=pdb=CToolFrameworkClient=15
...
public: virtual float CChoreoEvent::GetDuration(void)=55 8B EC 51 F3 ? ? ? ? 0F ? ? ? ? ? ? F3=pdb=CChoreoEvent=0
...
public: bool CChoreoEvent::IsProcessing(void)const=8A ? ? ? ? ? C0 E8 04 24 01 C3=pdb=vgui::TreeView=252
...
public: void CChoreoEvent::SetActive(bool)=55 8B EC 8A 45 08 C0 E0 06=pdb=vgui::ListPanel=228
public: void CChoreoEvent::SetPlayOverScript(bool)=55 8B EC 8A ? ? ? ? ? 8A 45 08=pdb=CNewParticleEffect=4
public: void CChoreoEvent::SetTrackLookupSet(bool)=55 8B EC 8A 45 08 C0 E0 03 32 ? ? ? ? ? 24 08 30 ? ? ? ? ? 5D=pdb=vgui::ListPanel=261
...
public: bool CParticleCollection::IsBatchable(void)const=8A ? ? ? ? ? C0 E8 07 C3=pdb=CNewParticleEffect=3
...
public: void bf_write::WriteShort(int)=55 8B EC 6A 10 FF 75 08 E8 ? ? ? ? 5D=pdb=CSave=31
...
public: class Color vgui::Panel::GetDropFrameColor(void)=55 8B EC 8B 45 08 8B 49 30=pdb=vehicleview_t=11
...
public: virtual void vgui::Panel::OnThink(void)=55 8B EC 83 EC 20 53 8B D9 89 5D FC 8B 43=pdb=C_CSRootPanel=101
...
public: virtual void vgui::Panel::PerformLayout(void)=55 8B EC 83 EC 10 56 8B F1 8B ? ? ? ? ? 85 C9 74=pdb=vgui::GraphPanel=132
...
public: virtual void CheckImage::Paint(void)=55 8B EC 83 EC 14 53 8B D9 56 89=pdb=CheckImage=0
...
public: virtual void vgui::ListPanel::ApplyItemChanges(int)=55 8B EC 56 FF 75 08 8B F1 E8 ? ? ? ? 8B 06 8B CE 6A 00 6A 00 FF=pdb=vgui::ListPanel=239
AscendingSortFunc()=55 8B EC 8B 45 08 8B ? ? ? ? ? 56 57=pdb
FastSortFunc()=55 8B EC 8B 45 0C 8B 4D 10 56=pdb
public: virtual int vgui::ListPanel::GetItemCurrentRow(int)=55 8B EC 8B ? ? ? ? ? 33 C0 56 85 D2 7E 1C 8B ? ? ? ? ? 8B 75 08 0F ? ? ? ? ? ? 39=pdb=vgui::ListPanel=233
protected: virtual int vgui::ListPanel::GetStartItem(void)=55 8B EC 51 56 57 8B F9 8B 07 8B=pdb=vgui::ListPanel=278
public: virtual bool vgui::ListPanel::IsItemSelected(int)=55 8B EC 8B 55 08 56 8B F1 57 85 D2 78=pdb=vgui::ListPanel=257
public: virtual void vgui::ListPanel::SetFont(unsigned long)=55 8B EC 56 8B 75 08 57 8B F9 85 F6 74 27=pdb=vgui::ListPanel=252
public: virtual void Dragger::SetMovable(bool)=55 8B EC 53 8A 5D 08 56 8B F1 8B 06=pdb=Dragger=211
...
public: virtual void vgui::ListViewItem::PerformLayout(void)=55 8B EC 83 EC 08 53 8B D9 56 57 8B 03 FF ? ? ? ? ? 80=pdb=vgui::ListViewItem=132
public: virtual void vgui::ListViewPanel::RemoveItem(int)=55 8B EC 51 56 8B 75 08 89 4D FC 57=pdb=vgui::ListViewPanel=215
...
protected: virtual void vgui::MenuBar::OnMenuClose(void)=8B 01 6A 00 FF 50 30 C3=pdb=vgui::MenuBar=214
protected: virtual void vgui::MenuBar::Paint(void)=55 8B EC 83 EC 08 53 8B D9 56 8B ? ? ? ? ? 57 8B 03 89=pdb
public: virtual void MenuItemCheckImage::Paint(void)=55 8B EC 51 56 57 8B F9 8B 37 FF=pdb=MenuItemCheckImage=0
...
public: virtual void RadioImage::Paint(void)=55 8B EC 51 57 8B F9 8B 07 FF 77=pdb=RadioImage=0
...
public: virtual void vgui::TreeView::ExpandItem(int,bool)=55 8B EC 8B 55 08 56 8B F1 85 D2 78 40=pdb=vgui::TreeView=243
public: virtual int vgui::TreeView::GetChild(int,int)=55 8B EC 8B 45 08 8D 14 40 8B ? ? ? ? ? 8B 04 90 8B ? ? ? ? ? 8B=pdb=vgui::TreeView=214
public: virtual int vgui::TreeView::GetItemParent(int)const=55 8B EC 8B 45 08 8D 14 40 8B ? ? ? ? ? 8B 04 90 8B ? ? ? ? ? 5D=pdb=vgui::TreeView=220
public: virtual int vgui::TreeView::GetNumChildren(int)=55 8B EC 8B 45 08 8B D1 83 F8 FF 75=pdb=vgui::TreeView=213
public: virtual int vgui::TreeView::GetRootItemIndex(void)=8B ? ? ? ? ? 85 C0 74 07 8B ? ? ? ? ? C3 83=pdb=vgui::TreeView=212
public: virtual void vgui::TreeView::MakeItemVisible(int)=55 8B EC 8B 45 08 53 56 57 8B F9 8D 14=pdb=vgui::TreeView=245
public: virtual void vgui::TreeNodeText::OnKillFocus(void)=56 8B F1 E8 ? ? ? ? 6A=pdb=vgui::TreeNodeText=99
protected: virtual void vgui::TreeView::OnMouseWheeled(int)=55 8B EC 56 8B F1 8B ? ? ? ? ? 8B 01 8B ? ? ? ? ? FF D0 84 C0 74 29=pdb=vgui::TreeView=108
public: virtual void vgui::TreeNode::OnSetFocus(void)=8B ? ? ? ? ? 6A 00 8B 01 FF 50 30 C3=pdb=vgui::TreeNode=98
protected: virtual void vgui::TreeView::OnSliderMoved(int)=56 8B F1 6A 00 6A 00 8B 06 FF ? ? ? ? ? 8B 06 8B CE FF 50=pdb
public: virtual void vgui::TreeNodeText::OnTextChanged(void)=8B 01 FF ? ? ? ? ? 6A 00 6A 00 8B C8=pdb=vgui::TreeNodeText=287
public: virtual void vgui::TreeNode::Paint(void)=56 8B F1 83 ? ? ? ? ? ? 7F=pdb=vgui::TreeNode=128
public: virtual void vgui::TreeView::RangeSelectItems(int)=55 8B EC 83 EC 18 56 8B F1 8B ? ? ? ? ? 85 D2=pdb
public: virtual void vgui::TreeView::RemoveAll(void)=56 57 8B F9 33 F6 39 ? ? ? ? ? 7E 41=pdb=vgui::TreeView=218
public: void vgui::TreeNode::RemoveChildren(void)=56 57 8B F9 8B ? ? ? ? ? 83 EE 01 78 27=pdb
public: virtual void vgui::TreeView::RemoveSelectedItem(int)=55 8B EC 56 57 8B 7D 08 8B F1 85 FF 0F ? ? ? ? ? 3B ? ? ? ? ? 0F=pdb=vgui::TreeView=225
public: void vgui::TreeNode::SetFont(unsigned long)=55 8B EC 53 8B 5D 08 57 8B F9 85 DB 74 50=pdb
public: virtual void vgui::TreeView::SetFont(unsigned long)=55 8B EC 56 57 8B 7D 08 8B F1 85 FF 74 3C=pdb=vgui::TreeView=221
public: void vgui::TreeNode::SetNodeExpanded(bool)=55 8B EC 8A 45 08 56 8B F1 88 ? ? ? ? ? 84 C0 74 51=pdb
public: virtual void vgui::TreeNode::StepInto(bool)=55 8B EC 56 8B F1 80 ? ? ? ? ? ? 75 07 6A=pdb=vgui::TreeNode=212
...
public: virtual void vgui::PanelListPanel::RemoveItem(int)=55 8B EC 83 EC 08 8B C1 56 8B=pdb=vgui::PanelListPanel=214
...
protected: virtual void vgui::Slider::Paint(void)=56 8B F1 8B 06 FF ? ? ? ? ? 8B 06 8B CE FF ? ? ? ? ? 8B 06 8B CE 5E=pdb=vgui::Slider=128
...
protected: virtual void vgui::CConsolePanel::OnThink(void)=56 8B F1 E8 ? ? ? ? 8B 06 8B CE 8B ? ? ? ? ? FF D0 84 C0 74 1C=pdb=vgui::CConsolePanel=101
...
public: virtual void vgui::BaseTooltip::HideTooltip(void)=8A 41 24 24=pdb=vgui::BaseTooltip=3
protected: virtual void vgui::BuildModeDialog::OnClose(void)=56 8B F1 8B ? ? ? ? ? 8B 01 8B 40 04=pdb=vgui::BuildModeDialog=235
public: virtual unsigned long vgui::TextImage::GetFont(void)=F6 41 34 10=pdb
public: virtual void vgui::TextImage::Paint(void)=55 8B EC 83 EC 28 56 8B F1 8D=pdb=vgui::TextImage=0
public: virtual void vgui::TextImage::SetFont(unsigned long)=55 8B EC 8B 45 08 80 49=pdb
protected: virtual void vgui::ScrollBarSlider::Paint(void)=55 8B EC 83 EC 0C 56 8B F1 8D 4D F4 51 8D=pdb=vgui::ScrollBarSlider=128
public: virtual void vgui::ScrollBarSlider::SetValue(int)=55 8B EC 8B 55 08 56 57 8B F9 8B ? ? ? ? ? 2B=pdb=vgui::ScrollBarSlider=211
private: void vgui::PropertySheet::ClearPageDropTab(void)=56 57 8B F9 8D ? ? ? ? ? C7 ? ? ? ? ? ? ? ? ? 56=pdb
public: virtual void vgui::PageTab::OnCursorEntered(void)=56 8B F1 8B ? ? ? ? ? 8B 01 FF 50 18 89 ? ? ? ? ? 5E=pdb=vgui::PageTab=103
public: virtual void vgui::PageTab::OnThink(void)=56 8B F1 80 ? ? ? ? ? ? 74 48=pdb=vgui::PageTab=101
public: virtual void vgui::PropertySheet::OnThink(void)=56 8B F1 E8 ? ? ? ? 83 ? ? ? ? ? ? 74 20=pdb
public: virtual void vgui::PropertySheet::RequestFocus(int)=55 8B EC 8B 55 08 56 8B F1 83 FA=pdb=vgui::PropertySheet=12
public: virtual void vgui::PropertySheet::SetSmallTabs(bool)=55 8B EC 8A 45 08 53=pdb=vgui::PropertySheet=257
public: virtual void vgui::PropertySheet::SetTabWidth(int)=55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 8B=pdb=vgui::PropertySheet=240
public: CVTFTexture::CVTFTexture(void)=C7 ? ? ? ? ? 0F 57 C0 C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? C7 ? ? ? ? ? ? 8B 41 5C=pdb
public: virtual float CVTFTexture::BumpScale(void)const=D9 41 40=pdb=CVTFTexture=24
public: virtual void CVTFTexture::ComputeAlphaFlags(void)=55 8B EC 83 EC 18 56 8B F1 81=pdb=CVTFTexture=49
public: virtual int CVTFTexture::ComputeFaceSize(int)const=55 8B EC FF 71 18 FF 75=pdb=CVTFTexture=35
public: virtual int CVTFTexture::ComputeTotalSize(void)const=56 8B F1 FF 76 18 6A=pdb=CVTFTexture=36
public: virtual bool CVTFTexture::ConstructLowResImage(void)=55 8B EC 83 EC 54 56 8B=pdb=CVTFTexture=50
public: virtual int CVTFTexture::FileSize(int)const=55 8B EC 57 6A 30=pdb=CVTFTexture=13
public: virtual bool CVTFTexture::IsCubeMap(void)const=8B 41 2C C1 E8 0E=pdb=CVTFTexture=29
public: virtual bool CVTFTexture::IsNormalMap(void)const=8B 41 2C C1 E8 07 83=pdb=CVTFTexture=30
public: virtual bool CVTFTexture::IsVolumeTexture(void)const=83 79 14 01 0F=pdb=CVTFTexture=31
...
CBenchmarkDialog::RunBenchmark()=56 8B F1 8B ? ? ? ? ? E8 ? ? ? ? 8B=lumina=CBenchmarkDialog=279
...
public: void ceng::ui::CWindowWidget::OnDragBy()=55 8B EC F3 ? ? ? ? 83 EC 08 F3 ? ? ? ? ? F3=lumina=CCSGO_MapOverview=19
...
vgui::ToggleButton::ApplySchemeSettings()=55 8B EC 57 FF 75 08 8B F9 E8 ? ? ? ? FF 75 08 8B 07=lumina=vgui::ToggleButton=88
...
CEconItemDescription::Generate_ScorecardDesc_PostPhoenix()=8B 4C 24 0C 56 57=lumina=CEconItemDescription=24
...
public: virtual bool CryptoPP::MessageQueue::GetNextMessage()=83 EC 18 56 8B F1 8B 06 FF 50=lumina=CryptoPP::MessageQueue=25
...
CNewParticleEffect::DrawModel()=55 8B EC 83 E4 F8 83 EC 5C 53 56 57=lumina=CLocalSpaceEmitter=167
...
C_CSPlayer::UpdateClientsideAnimation()=55 8B EC 51 56 8B F1 80 BE ? ? ? ? ? 74=lumina=C_CSPlayer=224
