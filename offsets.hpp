...
namespace Offsets {
	namespace DT_TestTraceline {
		...
		int m_angRotation0 = 0x12c;
		int m_angRotation1 = 0x130;
		int m_angRotation2 = 0x134;
	...
	namespace DT_TEPhysicsProp {
		int m_vecOrigin = 0x10;
		int m_angRotation0 = 0x1c;
		int m_angRotation1 = 0x20;
		int m_angRotation2 = 0x24;
	...
	namespace DT_TEParticleSystem {
		int m_vecOrigin0 = 0x10;
		int m_vecOrigin1 = 0x14;
		int m_vecOrigin2 = 0x18;
	}
	...
	namespace DT_TEShatterSurface {
		...
		int m_uchFrontColor0 = 0x54;
		int m_uchFrontColor1 = 0x55;
		int m_uchFrontColor2 = 0x56;
		int m_uchBackColor0 = 0x57;
		int m_uchBackColor1 = 0x58;
		int m_uchBackColor2 = 0x59;
	}
	...
	namespace DT_SmokeStack {
		...
		int m_AmbientLightm_vPos = 0xb34;
		int m_AmbientLightm_vColor = 0xb40;
		int m_AmbientLightm_flIntensity = 0xb4c;
		int m_DirLightm_vPos = 0xb50;
		int m_DirLightm_vColor = 0xb5c;
		int m_DirLightm_flIntensity = 0xb68;
		int m_vWind = 0xb78;
	}
	...
	namespace DT_WeaponTablet {
		int m_flUpgradeExpirationTime0 = 0x33d8;
		int m_flUpgradeExpirationTime = 0x0;
		int m_vecLocalHexFlags0 = 0x33e8;
		...
		int m_vecNotificationIds0 = 0x34b4;
		int m_vecNotificationIds = 0x0;
		int m_vecNotificationTimestamps0 = 0x34d4;
		int m_vecNotificationTimestamps = 0x0;
		int m_vecPlayerPositionHistory0 = 0x34f8;
	...
	namespace DT_Drone {
		...
		int m_vecTagPositions0 = 0x29ec;
		int m_vecTagPositions = 0x0;
		int m_vecTagIncrements0 = 0x2b0c;
	...
	namespace DT_TEFireBullets {
		...
		int m_vecAngles0 = 0x24;
		int m_vecAngles1 = 0x28;
	...
	namespace DT_CSPlayer {
		int m_angEyeAngles0 = 0xb37c;
		int m_angEyeAngles1 = 0xb380;
	...
	namespace DT_Ragdoll {
		int m_ragAngles0 = 0x2aa0;
		int m_ragAngles = 0x0;
		int m_ragPos0 = 0x2980;
		int m_ragPos = 0x0;
	...
	namespace DT_PropVehicleChoreoGeneric {
		...
		int m_vecEyeExitEndpoint = 0x2a00;
		int m_vehicleViewbClampEyeAngles = 0x2a90;
		int m_vehicleViewflPitchCurveZero = 0x2a94;
		int m_vehicleViewflPitchCurveLinear = 0x2a98;
		int m_vehicleViewflRollCurveZero = 0x2a9c;
		int m_vehicleViewflRollCurveLinear = 0x2aa0;
		int m_vehicleViewflFOV = 0x2aa4;
		int m_vehicleViewflYawMin = 0x2aa8;
		int m_vehicleViewflYawMax = 0x2aac;
		int m_vehicleViewflPitchMin = 0x2ab0;
		int m_vehicleViewflPitchMax = 0x2ab4;
	}
	...
	namespace DT_BaseTeamObjectiveResource {
		...
		int m_vCPPositions0 = 0x9f4;
		int m_vCPPositions = 0x0;
		int m_iszWarnSound0 = 0x1304;
	...
	namespace DT_EnvScreenOverlay {
		int m_iszOverlayNames0 = 0x9d8;
		int m_iszOverlayNames = 0x0;
		int m_flOverlayTimes0 = 0x13d0;
	...
	namespace DT_FogController {
		int m_fogenable = 0xa1c;
		int m_fogblend = 0xa1d;
		int m_fogdirPrimary = 0x9dc;
		int m_fogcolorPrimary = 0x9e8;
		int m_fogcolorSecondary = 0x9ec;
		int m_fogstart = 0x9f8;
		int m_fogend = 0x9fc;
		int m_fogfarz = 0xa00;
		int m_fogmaxdensity = 0xa04;
		int m_fogcolorPrimaryLerpTo = 0x9f0;
		int m_fogcolorSecondaryLerpTo = 0x9f4;
		int m_fogstartLerpTo = 0xa08;
		int m_fogendLerpTo = 0xa0c;
		int m_fogmaxdensityLerpTo = 0xa10;
		int m_foglerptime = 0xa14;
		int m_fogduration = 0xa18;
		int m_fogHDRColorScale = 0xa24;
		int m_fogZoomFogScale = 0xa20;
	}
	...
	namespace DT_LocalPlayerExclusive {
		int m_vecViewOffset0 = 0x108;
		int m_vecViewOffset1 = 0x10c;
		int m_vecViewOffset2 = 0x110;
		int m_flFriction = 0x144;
		int m_fOnTarget = 0x3324;
		int m_nTickBase = 0x3430;
		int m_nNextThinkTick = 0xfc;
		int m_hLastWeapon = 0x32f4;
		int m_vecVelocity0 = 0x114;
		int m_vecVelocity1 = 0x118;
		int m_vecVelocity2 = 0x11c;
	...
	namespace DT_Local {
		...
		int m_skybox3dscale = 0x134;
		int m_skybox3dorigin = 0x138;
		int m_skybox3darea = 0x144;
		int m_skybox3dfogenable = 0x18c;
		int m_skybox3dfogblend = 0x18d;
		int m_skybox3dfogdirPrimary = 0x14c;
		int m_skybox3dfogcolorPrimary = 0x158;
		int m_skybox3dfogcolorSecondary = 0x15c;
		int m_skybox3dfogstart = 0x168;
		int m_skybox3dfogend = 0x16c;
		int m_skybox3dfogmaxdensity = 0x174;
		int m_skybox3dfogHDRColorScale = 0x194;
		int m_audiolocalSound0 = 0x19c;
		int m_audiolocalSound1 = 0x1a8;
		int m_audiolocalSound2 = 0x1b4;
		int m_audiolocalSound3 = 0x1c0;
		int m_audiolocalSound4 = 0x1cc;
		int m_audiolocalSound5 = 0x1d8;
		int m_audiolocalSound6 = 0x1e4;
		int m_audiolocalSound7 = 0x1f0;
		int m_audiosoundscapeIndex = 0x1fc;
		int m_audiolocalBits = 0x200;
		int m_audioentIndex = 0x204;
