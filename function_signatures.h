namespace "CLIENT.dll" {
	...
	std::error_category::equivalent() = "55 8B EC 8B 01 8D 55 F8 83 EC 08 56";
	std::error_category::equivalent() = "55 8B EC 8B 41 04 56";
	...
	CryptoPP::PK_Verifier::Verify() = "55 8B EC 6A FF 68 ? ? ? ? 64 ? ? ? ? ? 50 53";
	...
	CryptoPP::Integer::BERDecode() = "55 8B EC 6A FF 68 ? ? ? ? 64 ? ? ? ? ? 50 83 EC 2C A1 ? ? ? ? 33 C5 89 45 F0 53 56";
	...
	CryptoPP::Integer::IsUnit() = "8B 41 08 8B 51 0C 85";
	...
	unsigned CryptoPP::Filter::CopyRangeTo2() = "8B 01 FF ? ? ? ? ? FF 74 24 18 8B C8 FF";
	CryptoPP::Store::GetNextMessage() = "56 8B F1 80 7E 10 00 75";
	CryptoPP::ByteQueue::IsolatedInitialize() = "51 56 8B F1 C7 ? ? ? ? ? ? ? 8B 4C";
	unsigned CryptoPP::ByteQueue::Peek() = "8B 41 14 8B 50";
	...
	CryptoPP::MessageQueue::GetNextMessage() = "83 EC 18 56 8B F1 8B 06 FF 50";
